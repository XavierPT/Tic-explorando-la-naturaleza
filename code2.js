...
gdjs.AVideoCode.asyncCallback22794260 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.AVideoCode.asyncCallback22794260(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.AVideoCode.GDWhiteDecoratedButtonObjects1.length;i<l;++i) {
    if ( gdjs.AVideoCode.GDWhiteDecoratedButtonObjects1[i].getVariableNumber(gdjs.AVideoCode.GDWhiteDecoratedButtonObjects1[i].getVariables().get("Sonido")) == 2 ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.AVideoCode.GDWhiteDecoratedButton2Objects1.length;i<l;++i) {
    if ( gdjs.AVideoCode.GDWhiteDecoratedButton2Objects1[i].getVariableNumber(gdjs.AVideoCode.GDWhiteDecoratedButton2Objects1[i].getVariables().get("Sonido")) == 2 ) {
        isConditionTrue_0 = true;
...
{gdjs.evtTools.sound.playSound(runtimeScene, "correcto.mp3", false, 50, 1);
    ...
    gdjs.AVideoCode.GDAnimalesVideoObjects1[i].setCurrentTime(0);
}
}}
