...
gdjs.FinaACode.GDNewSpriteObjects4= [];
...
gdjs.FinaACode.GDTitulo_9595del_9595juegoObjects4= [];
...
gdjs.FinaACode.GDWhiteDecoratedButtonObjects4= [];
...
gdjs.FinaACode.GDWhiteSquareDecoratedButtonObjects4= [];
...
gdjs.FinaACode.GDWhiteDecoratedButton2Objects4= [];
gdjs.FinaACode.GDInstruccionObjects1= [];
gdjs.FinaACode.GDInstruccionObjects2= [];
gdjs.FinaACode.GDInstruccionObjects3= [];
gdjs.FinaACode.GDInstruccionObjects4= [];


gdjs.FinaACode.asyncCallback23677076 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.FinaACode.asyncCallback23677076(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.FinaACode.asyncCallback23678820 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.FinaACode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.FinaACode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.FinaACode.asyncCallback23678820(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.FinaACode.asyncCallback23683708 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.FinaACode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "A1", false);
}{runtimeScene.getGame().getVariables().getFromIndex(0).setNumber(0);
}{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(5);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.FinaACode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.FinaACode.asyncCallback23683708(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.FinaACode.asyncCallback23685652 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.FinaACode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Menu", false);
}{runtimeScene.getGame().getVariables().getFromIndex(0).setNumber(0);
}{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(5);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.FinaACode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.FinaACode.asyncCallback23685652(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButtonObjects1.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButtonObjects1[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButtonObjects1[i].getVariables().get("Sonido")) == 3 ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButton2Objects1.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButton2Objects1[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButton2Objects1[i].getVariables().get("Sonido")) == 3 ) {
        isConditionTrue_0 = true;
...
gdjs.copyArray(gdjs.FinaACode.GDWhiteDecoratedButtonObjects2, gdjs.FinaACode.GDWhiteDecoratedButtonObjects3);

gdjs.copyArray(gdjs.FinaACode.GDWhiteDecoratedButton2Objects2, gdjs.FinaACode.GDWhiteDecoratedButton2Objects3);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButtonObjects3.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[i].getVariables().get("Sonido")) == 1 ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[k] = gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[i];
        ++k;
    }
}
gdjs.FinaACode.GDWhiteDecoratedButtonObjects3.length = k;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButton2Objects3.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[i].getVariables().get("Sonido")) == 1 ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[k] = gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[i];
        ++k;
    }
}
gdjs.FinaACode.GDWhiteDecoratedButton2Objects3.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.FinaACode.GDWhiteDecoratedButtonObjects3 */
/* Reuse gdjs.FinaACode.GDWhiteDecoratedButton2Objects3 */
{gdjs.evtTools.sound.playSound(runtimeScene, "Accesibility-audio\\Menu\\intentardenuevo.mp3", false, 100, 1);
}{for(var i = 0, len = gdjs.FinaACode.GDWhiteDecoratedButtonObjects3.length ;i < len;++i) {
    gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[i].returnVariable(gdjs.FinaACode.GDWhiteDecoratedButtonObjects3[i].getVariables().get("SonidoReproducido")).setBoolean(true);
}
for(var i = 0, len = gdjs.FinaACode.GDWhiteDecoratedButton2Objects3.length ;i < len;++i) {
    gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[i].returnVariable(gdjs.FinaACode.GDWhiteDecoratedButton2Objects3[i].getVariables().get("SonidoReproducido")).setBoolean(true);
}
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButtonObjects2.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButtonObjects2[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButtonObjects2[i].getVariables().get("Sonido")) == 3 ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDWhiteDecoratedButtonObjects2[k] = gdjs.FinaACode.GDWhiteDecoratedButtonObjects2[i];
        ++k;
    }
...
gdjs.FinaACode.GDWhiteDecoratedButtonObjects2.length = k;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButton2Objects2.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButton2Objects2[i].getVariableNumber(gdjs.FinaACode.GDWhiteDecoratedButton2Objects2[i].getVariables().get("Sonido")) == 3 ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDWhiteDecoratedButton2Objects2[k] = gdjs.FinaACode.GDWhiteDecoratedButton2Objects2[i];
        ++k;
    }
...
};gdjs.FinaACode.eventsList6 = function(runtimeScene) {
...
{ //Subevents
gdjs.FinaACode.eventsList5(runtimeScene);} //End of subevents
}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDInstruccionObjects1.length;i<l;++i) {
    if ( gdjs.FinaACode.GDInstruccionObjects1[i].getVariableNumber(gdjs.FinaACode.GDInstruccionObjects1[i].getVariables().getFromIndex(2)) == 2 ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDInstruccionObjects1[k] = gdjs.FinaACode.GDInstruccionObjects1[i];
        ++k;
    }
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDInstruccionObjects1.length;i<l;++i) {
    if ( gdjs.FinaACode.GDInstruccionObjects1[i].getVariableBoolean(gdjs.FinaACode.GDInstruccionObjects1[i].getVariables().getFromIndex(1), false, false) ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDInstruccionObjects1[k] = gdjs.FinaACode.GDInstruccionObjects1[i];
        ++k;
    }
...
{gdjs.evtTools.sound.playSound(runtimeScene, "Accesibility-audio\\FIN\\intento1.mp3", false, 100, 1);
    ...
    gdjs.FinaACode.GDInstruccionObjects1[i].returnVariable(gdjs.FinaACode.GDInstruccionObjects1[i].getVariables().getFromIndex(1)).setBoolean(true);
}
}}
...
};gdjs.FinaACode.eventsList7 = function(runtimeScene) {
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.FinaACode.GDWhiteDecoratedButton2Objects1.length;i<l;++i) {
    if ( gdjs.FinaACode.GDWhiteDecoratedButton2Objects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.FinaACode.GDWhiteDecoratedButton2Objects1[k] = gdjs.FinaACode.GDWhiteDecoratedButton2Objects1[i];
        ++k;
    }
...
{ //Subevents
gdjs.FinaACode.eventsList6(runtimeScene);} //End of subevents
}
...
gdjs.FinaACode.GDNewSpriteObjects4.length = 0;
...
gdjs.FinaACode.GDTitulo_9595del_9595juegoObjects4.length = 0;
...
gdjs.FinaACode.GDWhiteDecoratedButtonObjects4.length = 0;
...
gdjs.FinaACode.GDWhiteSquareDecoratedButtonObjects4.length = 0;
...
gdjs.FinaACode.GDWhiteDecoratedButton2Objects4.length = 0;
...
gdjs.FinaACode.GDInstruccionObjects4.length = 0;

gdjs.FinaACode.eventsList7(runtimeScene);
gdjs.FinaACode.GDNewSpriteObjects1.length = 0;
gdjs.FinaACode.GDNewSpriteObjects2.length = 0;
gdjs.FinaACode.GDNewSpriteObjects3.length = 0;
gdjs.FinaACode.GDNewSpriteObjects4.length = 0;
