...
gdjs.SVideoCode.asyncCallback24283084 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.SVideoCode.asyncCallback24283084(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.SVideoCode.GDWhiteDecoratedButtonObjects1.length;i<l;++i) {
    if ( gdjs.SVideoCode.GDWhiteDecoratedButtonObjects1[i].getVariableNumber(gdjs.SVideoCode.GDWhiteDecoratedButtonObjects1[i].getVariables().get("Sonido")) == 2 ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.SVideoCode.GDWhiteDecoratedButton2Objects1.length;i<l;++i) {
    if ( gdjs.SVideoCode.GDWhiteDecoratedButton2Objects1[i].getVariableNumber(gdjs.SVideoCode.GDWhiteDecoratedButton2Objects1[i].getVariables().get("Sonido")) == 2 ) {
        isConditionTrue_0 = true;
...
{gdjs.evtTools.sound.playSound(runtimeScene, "correcto.mp3", false, 50, 1);
    ...
    gdjs.SVideoCode.GDAnimalesVideoObjects1[i].setCurrentTime(0);
}
}}
